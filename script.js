document.addEventListener('DOMContentLoaded', function () {
  ...
  function initScrollAnimations() {
    ...
    elements.forEach(function (el, index) {
      ...
      if (parent) {
        const siblings = parent.querySelectorAll(ANIMATION_SELECTORS);
        siblings.forEach(function (sibling, i) {
          if (!sibling.style.transitionDelay) {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Packaging Sign uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6c292d68-26f4-4325-952e-c9640f2b1ad6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6c292d68-26f4-4325-952e-c9640f2b1ad6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6c292d68-26f4-4325-952e-c9640f2b1ad6';
